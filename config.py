...
class Config:
    ...
    CACHE_BLOCKS_INTERVAL = int(get_config_value("webui", "cache_blocks_interval", default=15, is_numeric=True))
    CACHE_REWARDS_INTERVAL = int(get_config_value("webui", "cache_rewards_interval", default=15, is_numeric=True))
